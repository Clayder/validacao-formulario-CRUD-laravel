...
<div class="form-group">
    ...
    <input type="text" class="form-control" name="physical_disability" id="physical_disability" value="{{old('physical_disability',$client->physical_disability)}}">
</div>
<div class="checkbox">
    <label>
        <input type="checkbox" class="" name="defaulter" id="defaulter" {{old('defaulter',$client->defaulter) ? 'checked = "checked"':''}}> Inadimplente ?
    </label>
</div>
